...
export function hashLeaf(pubkey, amountLe8) {
...
export function getProof(leaves, index) {
...
export function to32Bytes(pubkeyBase58) {
...
export function toLe8Bytes(num) {
